<?php
/**
 * Plugin Name: cws Admin Color Scheme
 ...
 * Version: 1.0
 * Text Domain: cws-color-scheme
 * License: GPL2
 *
 * Copyright 2013 Objective Subject
 */

class cws_Admin_Color_Scheme {
	...
	function load_default_css() {
		...
		if ( 'cws' === $color_scheme || in_array( get_current_screen()->base, array( 'profile', 'profile-network' ) ) ) {
